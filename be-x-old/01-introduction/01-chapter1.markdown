...
Увага! Гэта галоўнае, што вам трэба запомніць пра Git, калі вы хочаце, каб далей навучаньне пайшло гладка. Git мае тры галоўныя станы, у якіх могуць знаходзіцца вашы файлы: *зафіксаваны (закамітаваны ад англ. commited)*, *мадыфікаваны* і *падрыхтаваны (англ. staged)*. Зафіксаваныя  файлы — тыя файлы, якія ўжо бясьпечна захоўваюцца ў лякальнай базе даньняў. Мадыфікаваныя файлы былі зьменены, але яшчэ не захаваны ў базу. Падрыхтаваныя — гэта зьмененыя файлы, якія былі пазначаныя для захаваньня пад час наступнага камітаваньня (сэансу захаваньня файлаў).

Гэта прыводзіць нас да трох галоўных сэкцый праекту ў Git: тэчкі Git (git directory на малюнку), працоўнай тэчкі (wokring directory) і прасторы рыхтаваньня (staging area).
