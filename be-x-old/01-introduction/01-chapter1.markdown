...
Наступнай вялікай праблемай, была неабходнасьць узаемадзейнічаць з распрацоўнікамі за іншымі кампутарамі. Цэнтралізаваныя сыстэмы кіраваньня вэрсіямі (ЦСКВ) былі распрацаваныя каб вырашыць гэтую праблему. Такія сыстэмы як CVS, Subversion і Perforce складаюцца з сэрвера, на якім захоўваюцца ўсе даньні па вэрсіях файлаў, і некаторай колькасьці кліенцкіх машын, якія атрымліваюць файлы з сэрвера. Шмат год такая схема зьяўлялася стандартам кіраваньня вэрсіямі (гл. Малюнак 1-2).
...
Гэтыя хэшы можна ўбачыць паўсюль у Git, бо яны выкарыстоўваюцца там вельмі часта. Фактычна, Git захоўвае ўсё ў сваёй базе даньняў не па імёнах файлаў, а па хэш-сумах зьмесціва даньняў.
...
Увага! Гэта галоўнае, што вам трэба запомніць пра Git, калі вы хочаце, каб далей навучаньне пайшло гладка. Git мае тры галоўныя станы, у якіх могуць знаходзіцца вашы файлы: *зафіксаваны (закамітаваны ад англ. commited)*, *мадыфікаваны* і *праіндэксаваны (англ. staged)*. Зафіксаваныя  файлы — тыя файлы, якія ўжо бясьпечна захоўваюцца ў лякальнай базе даньняў. Мадыфікаваныя файлы былі зьменены, але яшчэ не захаваныя ў базу. Праіндэксаваныя — гэта зьмененыя файлы, якія былі пазначаныя для захаваньня пад час наступнага каміту (сэансу захаваньня файлаў).

Гэта прыводзіць нас да трох галоўных сэкцый праекту ў Git: тэчкі Git (git directory на малюнку), працоўнай тэчкі (wokring directory) і прасторы індэксацыі (staging area).

Insert 18333fig0106.png 
Малюнак 1-6. Працоўная тэчка, прастора індэксацыі і тэчка Git.

Тэчка Git гэта месца, дзе сыстэма захоўвае метаданьні й базу даньняў з аб’ектамі вашага праекту. Гэта найбольш важная частка Git і менавіта яе копія робіцца, калі вы клануеце сховішча зь іншага кампутара.

Працоўная тэчка гэта фактычна стан пэўнай вэрсіі праекту. Гэтыя файлы узятыя са сьціснутай базы даньняў у тэчцы Git і зьмешчаныя на дыску, каб вы маглі імі карыстацца й мадыфікаваць.

Прастора індэксацыі гэта звычыйны файл, звычайна зьмешчаны ў тэчцы Git, які захоўвае інфармацыю пра ўсё, што было абрана й пойдзе у наступны каміт. Часам яго яшчэ называюць *індэксам (index)*, і робіцца стандартам называць гэты файл *прасторай індэксацыі (staging area)*.
...
Цяпер вы маеце пэўнае ўяўленьне пра Git і яго карысныя адрозьненьні ад цэнтралізаваных СКВ. Апроч таго, вы ўжо павінны мець працоўную вэрсію Git у сваёй сыстэме з вашымі асабістымі зьвесткамі. Нарэшце прыйшоў час вывучыць некалькі базавых прыёмаў работы з Git.
