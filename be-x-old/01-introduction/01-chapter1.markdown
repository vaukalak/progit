...
Як і шмат іншых вялікіх рэчаў у жыцьці, Git пачынаўся са стваральнага разбурэньня і палымяных спрэчак. Ядро Linux — праграмны праект з адкрытым зыходным кодам даволі вялікага аб'ёму. На працягу большай часткі пэрыяду існаваньня ядра Linux(1991–2002) зьмены ў ім распаўсюджваліся ў выглядзе латак і архіваў. У 2002 годзе праект распрацоўкі ядра Linux пачаў карыстацца BitKeeper — прапрыетарнай РСКВ.
...
### Практычна ўсе апэрацыі выконваюцца лякальна ###
...
Увага! Гэта галоўнае, што вам трэба запомніць пра Git, калі вы хочаце, каб далей навучаньне пайшло гладка. Git мае тры галоўных станы, у якіх могуць знаходзіцца вашые файлы: *зафіксаваны (закамічаны ад англ. commited)*, *мадыфікаваны* і *праіндэксаваны (англ. staged)*. Зафіксаваны — тыя файлы, якія ўжо бясьпечна захоўваюцца ў лякальнай базе даньняў. Мадыфікаваныя файлы былі зьменены, але яшчэ не былі захаваныя ў базу. Праіндэксаваныя — гэта зьмененыя файлы, якія былі пазначаныя для захаваньня пад час наступнага каміту (сеанса захаваньня файлаў).

Гэта падводзіць нас да трох галоўных сэкцый праекту ў Git: тэчкі Git (git directory на малюнку), працоўнай тэчкі (wokring directory) і прасторы індэксацыі (staging area).
...
2.	Рыхтуеце файлы да захоўваньня ў базе, дадаючы іх адбітак у прастору індэксацыі.
...
Git умее працаваць з accepts kdiff3, tkdiff, meld, xxdiff, emerge, vimdiff, gvimdiff, ecmerge і opendiff. Апроч гэтага, вы можаце наладзіць сваё ўласнае дастасаваньне. Больш падрабязна напісана пра гэта ў *Главе 7*.
